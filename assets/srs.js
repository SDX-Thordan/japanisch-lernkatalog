...
(function () {
  ...
  // Bewusst hoch angesetzt: der Lernstand soll nach JEDER geübten Runde weiter steigen. Mit den
  // früheren Werten (40 / 2400) stand ein Wort schon nach zwei richtigen Antworten still, und
  // global war nach rund sechs intensiv geübten Wörtern Schluss — beim portionierten Listen-Üben
  // hätten dann dieselben Wörter immer wieder ganz vorn gestanden.
  var ITEM_DAILY_CAP = 400;  // max. Punktgewinn pro Wort und Tag
  var DAILY_CAP = 24000;     // max. Punktgewinn über alle Wörter pro Tag (global = „Lernlimit")
